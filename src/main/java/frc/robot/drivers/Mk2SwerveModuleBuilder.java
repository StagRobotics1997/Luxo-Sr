...
public class Mk2SwerveModuleBuilder {
     ...
     *                the analog encoder reading to obtain
     ...
     * been determined to work with all Mk2
     ...
     *              is set to output the module's angle
     *              in radians.
     * @return The builder.
     */
     ...
     * standard angle reduction
     * and a NEO, {@link #angleMotor(CANSparkMax)} uses already tuned constants so
     * no tuning is required.
     *
     * @param motor     The CAN Spark MAX to use as the angle motor. The NEO's
     *                  encoder is set to output the module's
     *                  angle in radians.
     ...
     *                  For example, an 18:1 ratio should be specified by
     *                  {@code 18.0 / 1.0}.
     * @return The builder.
     */
     ...
     * recommended wheel and stock drive
     * reduction. By default distance and velocity will be reported in inches and
     * inches per second.
     *
     * @param motor The CAN Spark MAX to use as the drive motor. The NEO's encoder
     *              is set to output the module's driven
     ...
     *                      encoder is set to output the module's driven
     *                      distance and current velocity. Units are the same as the
     *                      units used for the wheel diameter.
     * @param reduction     The drive reduction of the module. It should be
     *                      specified so the number is greater than 1.
     *                      For example, an 18:1 ratio should be specified by
     *                      {@code 18.0 / 1.0}.
