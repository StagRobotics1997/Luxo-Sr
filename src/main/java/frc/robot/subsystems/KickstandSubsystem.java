...
public class KickstandSubsystem extends SubsystemBase {
    private DoubleSolenoid kickerExtender = new DoubleSolenoid(12, PneumaticsModuleType.CTREPCM, KickstandConstants.KICKER_EXTENDER_1, KickstandConstants.KICKER_EXTENDER_2);
